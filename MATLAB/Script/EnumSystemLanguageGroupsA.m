...
%Execute
calllib('kernel32', 'EnumSystemLanguageGroupsA', hAlloc, 0 , []);
...
function [fcns, structs, enuminfo] = kernel32proto
    ...
    % Prototype for EnumSystemLanguageGroups
    fcns.name{2} = 'EnumSystemLanguageGroupsA';
    fcns.calltype{2} = 'cdecl';
    fcns.LHS{2} = 'int'; 
    fcns.RHS{2} = {'int64','uint32', 'uint32Ptr'};
end

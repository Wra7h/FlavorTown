...
%Execute
calllib('kernel32', 'EnumDateFormatsExA', hAlloc, hex2dec('0x0800'), 0);
...
function [fcns, structs, enuminfo] = kernel32proto
    ...
    % Prototype for EnumDateFormatsEx
    fcns.name{2} = 'EnumDateFormatsExA';
    fcns.calltype{2} = 'cdecl';
    fcns.LHS{2} = 'int'; 
    fcns.RHS{2} = {'int64', 'uint32', 'uint32'};
end
